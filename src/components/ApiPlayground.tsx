...
const endpoints: EndpointConfig[] = [
  ...
  },
  {
    id: 'omilife',
    method: 'GET',
    path: '/api/v1/projects/omilife',
    name: 'Omilife Architecture Schema',
    description: 'Queries metadata and architectural constraints for the healthcare supply chain platform.',
    responseHeaders: {
      'content-type': 'application/json; charset=utf-8',
      'x-response-time': '19ms',
      'x-cache': 'HIT (Redis-L1)',
      'etag': 'W/"7a3e9b1"',
    },
    defaultLatency: 19,
    responseBody: {
      project_id: 'omilife-health-sys',
      title: 'Omilife Healthcare Supply & Pharmacy Engine',
      architecture: {
        api_pattern: 'RESTful with JWT Authentication',
        persistence: 'MySQL with ACID inventory isolation',
        frontend: 'React 18 + TypeScript',
        role_access_control: ['SuperAdmin', 'Distributor', 'Pharmacist', 'Auditor'],
      },
      key_metrics: {
        catalog_skus: 12450,
        batch_expiry_tracking: 'Automated 30-day proactive alert pipeline',
        audit_trail: 'Immutable append-only ledger for regulated drugs',
      },
